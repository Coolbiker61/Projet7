...
exports.createMessage = (req, res, then) => {
    ...
    html += "<input type=\"text\" id=\"title\" maxlength=\"50\" pattern=\"(([\\wáàâäãåçéèêëíìîïñóòôöõúùûüýÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒ]{1})([\\w'\\sáàâäãåçéèêëíìîïñóòôöõúùûüýÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒ]{1,}))\" ><div><span id=\"length-title\">0</span>/50</div></div>";
